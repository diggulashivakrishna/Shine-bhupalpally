    ...
    <div ref={containerRef} className="relative">
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 h-[1000px] md:h-[800px]">
            ...
            >
              <img src="/src/assets/images/1.png" alt="Students with study materials" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 object-center" referrerPolicy="no-referrer" />
            ...
            >
              <img src="/src/assets/images/2.png" alt="Students with DNA model" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 object-center" referrerPolicy="no-referrer" />
            ...
            <motion.div 
              ...
              className="md:col-span-1 md:row-span-1 relative rounded-[40px] overflow-hidden group"
            >
              <img src="/src/assets/images/4.png" alt="Students with microscope" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 object-center" referrerPolicy="no-referrer" />
            </motion.div>
            ...
            >
              <img src="/src/assets/images/3.png" alt="Students looking at specimen" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 object-center" referrerPolicy="no-referrer" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="relative">
              ...
              >
                <img src="/src/assets/images/6.png" alt="Students collaborating" className="w-full h-full object-cover object-center" referrerPolicy="no-referrer" />
              </motion.div>
      ...
      <section className="h-[80vh] flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 relative overflow-hidden">
          <img src="/src/assets/images/1.png" alt="Join Shine" className="w-full h-full object-cover object-center" referrerPolicy="no-referrer" />
